...
/// @nodoc
@JsonSerializable()
class _$RecipeResponseImpl extends _RecipeResponse {
...
abstract class _RecipeResponse extends RecipeResponse {
  const factory _RecipeResponse(
      ...
      final double? rating,
      final int? reviewCount,
      final List<String>? mealType}) = _$RecipeResponseImpl;
